...
public class TestDialogueUIBehaviour : Yarn.Unity.DialogueUIBehaviour {
    ...
    public override System.Collections.IEnumerator RunOptions (Yarn.Options optionsCollection, Yarn.OptionChooser optionChooser)
    {
        ...
        if (expectedOptions.Count > 0) {
            string selection = expectedOptions.Dequeue();

            int index = optionsCollection.options.IndexOf(selection);
...
public class YarnSpinnerTests {
    ...
    public void SetUp()
    {
        ...
        GameObject dialogueHost = new GameObject();
        ...
        TextAsset text = AssetDatabase.LoadAssetAtPath<TextAsset>("Assets/Yarn Spinner/Examples/Demo Assets/Space.json");
