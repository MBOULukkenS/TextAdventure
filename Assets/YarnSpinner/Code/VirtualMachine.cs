    ...
    internal class VirtualMachine
    {
        ...
        public bool SetNode(string nodeName) {
            if (program.nodes.ContainsKey(nodeName) == false) {
                ...
                string error = "No node named " + nodeName;
        ...
        internal void RunInstruction(Instruction i) {
            ...
            case ByteCode.RunLine:
                 ...
                 */
                string lineText = program.GetString ((string)i.operandA);
            ...
            case ByteCode.Jump:
                 ...
                 */
                string jumpDestination = state.PeekValue ().AsString;
            ...
            case ByteCode.CallFunc:
                 ...
                 *  if it returns one.
                 */
                string functionName = (string)i.operandA;
            ...
            case ByteCode.PushVariable:
                ...
                Value loadedValue = dialogue.continuity.GetValue (variableName);
            ...
            case ByteCode.StoreVariable:
                 ...
                 */
                Value topValue = state.PeekValue ();
                string destinationVariableName = (string)i.operandA;
            ...
            case ByteCode.ShowOptions:
                ...
                if (state.currentOptions.Count == 1 && state.currentOptions[0].Key == null) {
                    string destinationNode = state.currentOptions[0].Value;
                ...
                foreach (KeyValuePair<string, string> option in state.currentOptions) {
                ...
                optionsHandler (new Dialogue.OptionSetResult (optionStrings, delegate (int selectedOption) {
                    ...
                    // to the stack
                    string destinationNode = state.currentOptions[selectedOption].Value;
                    state.PushValue(destinationNode);
